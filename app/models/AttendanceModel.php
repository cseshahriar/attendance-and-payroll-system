...
class AttendanceModel extends Database 
{
	...
	{
		$this->db->query("SELECT attendance.*, employees.firstname,employees.lastname FROM attendance INNER JOIN employees ON  attendance.employee_id = employees.employee_id ORDER BY id DESC"); 
		$rows = $this->db->get();   
		return $rows;  	   
	} 
